describe('about page as visitor', () => {
  beforeEach(()=>{
    cy.visit('/about');
  })

  it('about page loaded', () => {
  ...
  it('correct active nav', () => {
    ...
    cy.getDataTest('nav-about').should('have.class', 'active');
  ...
  it('correct header', () => {
    ...
    cy.getDataTest('welcome-here-page').should('contain.text', 'Here is the about page');
  })
